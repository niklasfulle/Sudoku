...
/**
 * Select a field out of the game strings
 */
...
/**
 * Counts the numbers who are set from the player
 */
function count() {
...
/**
 * Prints the number select on the screen
 */
